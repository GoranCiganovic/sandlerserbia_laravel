 <!-- ajax home confirm issued proinvoices-->
        ...
        @if(count($proinvoices) > 0)
          @foreach($proinvoices as $proinvoice)
            ...
            <a href='
              ...
              {{ url("/presentation/edit/".$proinvoice->client_id."/proinvoice/".$proinvoice->id) }}
              @else
              {{ url("edit/proinvoice/".$proinvoice->contract_id."/".$proinvoice->payment_id."/".$proinvoice->id) }}
              @endif
