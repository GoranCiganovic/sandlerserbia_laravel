    ...
    <div class="col-md-8 col-md-offset-2 col-sm-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-heading san-yell">
          ...
          <!-- Back Button -->
          <a href="{{ url('payment/'.$contract->id.'/'.$payment->id) }}" class="btn btn-default pull-right alert-san-grey"><i class="fa fa-btn fa-chevron-left" aria-hidden="true"></i>Rata</a>
          <!-- /Back Button -->
          <!-- Title -->
        ...
        <div class="panel-body san-yell"> 
          ...
          <form method="POST" id="form" class='form_prevent_multiple_submits' action='{{ url($type['type']."/store/".$contract->id."/".$payment->id) }}'>
            <!-- Vrednost-->
            <div class="form-group{{ $errors->has('value_euro') ? ' has-error' : '' }}">
              ...
              <div class="form-control">{{ $payment->value_euro }}</div>
              <input type="hidden" id="value_euro" name="value_euro" class="form-control" aria-describedby="value_euroHelp" value="{{ $payment->value_euro }}" step="0.01">
            ...
            <div class="form-group{{ $errors->has('value_din') ? ' has-error' : '' }}">
              ...
              <div class="value_din form-control">{{ $value_din }}</div>
              <input type="hidden" id="value_din" name="value_din" class="form-control" aria-describedby="value_dinHelp" value="{{ $value_din }}" step="0.01">
            ...
            <div class="form-group{{ $errors->has('pdv_din') ? ' has-error' : '' }}">
              ...
              <div class="pdv_din form-control">{{ $pdv_din }}</div>
              <input type="hidden" id="pdv_din" name="pdv_din" class="form-control" aria-describedby="pdv_dinHelp" value="{{ $pdv_din }}" step="0.01">
            ...
            <div class="form-group{{ $errors->has('value_din_tax') ? ' has-error' : '' }}">
              ...
              <div class="value_din_tax form-control">{{ $value_din_tax }}</div>
              <input type="hidden" id="value_din_tax" name="value_din_tax" class="form-control" aria-describedby="value_din_taxHelp" value="{{ $value_din_tax }}" step="0.01">
            ...
            <div class="form-group{{ $errors->has('format_issue_date') ? ' has-error' : '' }}">
              ...
              <input type="text" id="format_issue_date" name="format_issue_date" class="form-control" aria-describedby="format_issue_dateHelp" value='{{ date("d.m.Y.",strtotime($payment->pay_date)) }}'>
              <input type="hidden" id="issue_date" name="issue_date" value="{{ $payment->pay_date }}">
            ...
            <div class="form-group{{ $errors->has('format_traffic_date') ? ' has-error' : '' }}">
              ...
              <input type="text" id="format_traffic_date" name="format_traffic_date" class="form-control" aria-describedby="format_traffic_dateHelp" value='{{ date("d.m.Y.",strtotime($payment->pay_date)) }}'>
              <input type="hidden" id="traffic_date" name="traffic_date" value="{{ $payment->pay_date }}">
              @if ($errors->has('format_traffic_dateHelp'))
            ...
            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
              ...
              <textarea id="description" name="description" class="form-control" aria-describedby="descriptionHelp" rows="2">{{ $payment->description }}</textarea>
            ...
            <!-- /Datum ugovora -->
            <!-- FORM PDF ACTION -->
            <input type="hidden" id='form_pdf_action' name="form_pdf_action" value='{{ url("/pdf_preview/invoice/".$contract->client_id) }}'>
            <!-- /ORM PDF ACTION -->
            <!-- Button -->
...
<script src="/js/invoices/pdf.js"></script>
