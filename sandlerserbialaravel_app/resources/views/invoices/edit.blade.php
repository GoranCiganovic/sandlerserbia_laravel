    ...
    <div class="col-md-8 col-md-offset-2 col-sm-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body san-yell">
          ...
          <form method="POST" id='form' class='form_prevent_multiple_submits' action='{{ url($type['type']."/update/".$contract->id."/".$payment->id."/".$invoice->id) }}'>
            <!-- Vrednost -->
            ...
            <!-- /Datum ugovora -->
            <!-- FORM PDF ACTION -->
            <input type="hidden" id='form_pdf_action' name="form_pdf_action" value='{{ url("pdf/".$type['type']."/".$invoice->id."/".$contract->client_id) }}'>
            <!-- /FORM PDF ACTION -->
            <!-- FORM ISSUED ACTION -->
            <input type="hidden" id='form_issued_action' name="form_issued_action" value='{{ url("/".$type['type']."/issued/".$contract->id."/".$payment->id."/".$invoice->id) }}'>
            <!-- /FORM ISSUED ACTION -->
            <!-- FORM DELETE ACTION -->
            <input type="hidden" id='form_delete_action' name="form_delete_action" value='{{ url("/".$type['type']."/delete/".$contract->id."/".$payment->id."/".$invoice->id) }}'>
            <!-- /FORM DELETE ACTION -->
            <!-- Button  Update -->
