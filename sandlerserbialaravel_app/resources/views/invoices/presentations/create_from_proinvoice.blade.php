    ...
    <div class="col-md-8 col-md-offset-2 col-sm-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body san-yell">
          ...
          <form method="POST" id='form' class='form_prevent_multiple_submits' action='{{ url("/presentation/update/".$client->id.'/invoice/'.$invoice->id) }}'>
            ...
            <!-- /Token -->
            <!-- FORM PDF ACTION -->
            <input type="hidden" id='form_pdf_action' name="form_pdf_action" value='{{ url("pdf/invoice/".$invoice->id."/".$client->id) }}'>
            <!-- /FORM PDF ACTION -->
            <!-- FORM ISSUED ACTION -->
            <input type="hidden" id='form_issued_action' name="form_issued_action" value='{{ url("/presentation/issued/".$client->id."/invoice/".$invoice->id) }}'>
            <!-- /FORM ISSUED ACTION -->
            <!-- Button -->
            ...
            <div class="panel panel-default san-light">
              <button type="submit" id="issued" name="issued" class='button_prevent_multiple_submits btn btn-info btn-md btn-block'>
                  <i class="no_spinner fa fa-btn fa-external-link" aria-hidden="true"></i><i class='spinner fa fa-btn fa-spinner fa-spin' aria-hidden="true"></i>IZDAJ FAKTURU
              </button>
            </div>
            <!--/Button  Issued -->
            <!-- PDF -->
            <div class="panel panel-default san-light">
              <button type="submit" id="pdf_preview" name="pdf_preview" class='button_prevent_multiple_submits btn btn-default btn-md btn-block'>
                  <i class="no_spinner fa fa-btn fa-file-text-o" aria-hidden="true"></i><i class='spinner fa fa-btn fa-spinner fa-spin' aria-hidden="true"></i><span id="issuedTypeName">FAKTURA</span> PDF <i>(po izdavanju Faktura će dobiti broj)</i>
              </button>
            </div>
