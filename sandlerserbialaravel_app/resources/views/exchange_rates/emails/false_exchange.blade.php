        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body san-yell">
					<br>
					 <div>
					 	<p class="h4 text-primary">Neispravan je kurs koji se dobija sa sajta:</p>
					    <a class="btn btn-block btn-primary btn-text-left" href="{{ $exchange_url }}">
                            <span class='h5'>{{ $exchange_url }}</span>
                        </a>
					</div>
					<br><br>
					<div>
