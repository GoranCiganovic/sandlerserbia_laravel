    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading san-yell">Resetovanje lozinke</div>

                <div class="panel-body san-yell">
                    <form class="form_prevent_multiple_submits form-horizontal" id='form' name='form' method="POST" action="{{ url('/password/reset') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="button_prevent_multiple_submits btn btn-primary">
                                   <i class="no_spinner fa fa-btn fa-refresh" aria-hidden="true"></i><i class='spinner fa fa-btn fa-spinner fa-spin' aria-hidden="true"></i> Resetuj Lozinku
                                </button>
                            </div>
                        </div>
                    </form>
