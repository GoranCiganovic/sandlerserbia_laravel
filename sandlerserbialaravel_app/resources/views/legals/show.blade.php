      ...
      <div class="panel panel-default">
        ...
        <div class="panel-heading san-yell">
         ...
         <i class="fa fa-btn fa-list" aria-hidden="true"></i>
          {{ $client_status->global_name }} profil
          <!-- Back Button -->
          <a href="{{url('/home')}}" class="btn btn-default pull-right alert-san-grey">
            <i class="fa fa-btn fa-chevron-left" aria-hidden="true"></i>Početna
          </a>
          <!-- /Back Button -->
          <!-- Title -->
          <div class="text-center h3" id="confirm_name">{{ $legal->long_name }}</div>
          <!-- /Title -->
          <!-- Message -->
          ...
          <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right text-center">
              ...
              <div class="panel panel-default san-light">
                ...
                <form method="POST" id='form' class='form_prevent_multiple_submits' action='{{ url("legal/add_meeting_date/".$legal->id) }}'>
                  <!-- Datum sastanka  -->
              ...
              <div class="panel panel-default san-light">
                ...
                <a href='{{ url("/client/change_status/".$legal->client_id."/3") }}' class='change_status panel-body-sm btn btn-default btn-block bg-success' role='button'>
                    <i class="fa fa-btn fa-handshake-o" aria-hidden="true"></i>
                    <span class="">PRIHVATIO SASTANAK</span>
                </a>
                <a href='{{ url("/client/change_status/".$legal->client_id."/4") }}' class='change_status panel-body-sm btn btn-default btn-block bg-info' role='button'>
                    <i class="fa fa-btn fa-thumbs-o-up" aria-hidden="true"></i>
                    <span>JASNA PRECIZNA BUDUĆNOST</span>
                </a>
                <a href='{{ url("/client/change_status/".$legal->client_id."/2") }}' class='change_status panel-body-sm btn btn-default btn-block bg-danger' role='button'>
              ...
              <div class="panel panel-default san-light">
                ...
                <a href='{{ url("/client/edit/".$legal->client_id) }}' class='panel-body-sm btn btn-primary btn-block' role='button'>
              ...
              <div class="panel panel-default san-light">
                ...
                <a href='{{ url("/client/delete/".$legal->client_id."/".$legal->client_status_id) }}' id="delete_profile" class='button_spinner panel-body-sm btn btn-danger btn-block' role='button'>
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 pull-left text-left">
                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        @if($legal->conversation_date and $client_status->id != '6' and $client_status->id != '5' )
                        <tr>
                          <td><i class="fa fa-btn fa-calendar"></i>Datum statusa:</td>
                          <td class="text-center">
                            <span>{{ date('d.m.Y.', strtotime($legal->conversation_date)) }}</span>
                          </td>
                        </tr>
                        @endif
                        <!-- /Datum statusa (Prihvaio Sastanak, JPB ili Diskvalifikovan) -->
                        ...
                        <!-- Prihvatio sastanak  -->
                        @if($legal->accept_meeting_date)
                        <tr>
                          <td><i class="fa fa-btn fa-calendar"></i>Prihvatio sastanak:</td>
                          <td class="text-center">
                            <span>{{ date('d.m.Y.', strtotime($legal->accept_meeting_date)) }}</span>
                          </td>
                        </tr>
                        @endif
                        <!-- /Prihvatio sastanak -->
                        ...
                        <!-- Datum sastanka  -->
                        @if($legal->meeting_date)
                        <tr>
                          <td><i class="fa fa-btn fa-calendar"></i>Datum sastanka:</td>
                          <td class="text-center">
                            <span>{{ date('d.m.Y. - H:i', strtotime($legal->meeting_date)) }}h</span>
                          </td>
                        </tr>
                        @endif
                        <!-- /Datum sastanka  -->
                        ...
                        <!-- Postao klijent -->
                        @if($legal->closing_date)
                        <tr>
                          <td><i class="fa fa-btn fa-calendar"></i>Postao klijent:</td>
                          <td class="text-center">
                            <span>{{ date('d.m.Y.', strtotime($legal->closing_date)) }}</span>
                          </td>
                        </tr>
                        @endif
                        <!-- /Postao klijent  -->
                        ...
                        <!-- Direktor -->
                        <tr>
                          <td><i class="fa fa-btn fa-user"></i>&nbsp;Direktor:</td>
                          <td class="text-center">
                            <span>{{$legal->ceo}}</span>
                          </td>
                        </tr>
                        ...
                        <!-- Lice za razgovor -->
                        <tr>
                          <td><i class="fa fa-btn fa-user"></i>&nbsp;Lice za razgovor:</td>
                          <td class="text-center">
                            <span>{{$legal->contact_person}}</span>
                          </td>
                        </tr>
                        <!-- /Lice za razgovor  -->
                        ...
                        <tr>
                          <td><i class="fa fa-btn fa-phone"></i>Telefon lica za razgovor:</td>
                          <td class="text-center">
                            <span>{{$legal->contact_person_phone}}</span>
                          </td>
                        </tr>
                        <!-- /Telefon lica za razgovor  -->
                        ...
                        <!-- Website  -->
                        <tr>
                          <td><i class="fa fa-btn fa-globe"></i>Website:</td>
                          <td class="text-center">
                            <span>{{$legal->website}}</span>
                          </td>
                        </tr>
                        <!-- /Website  -->
