$(document).ready(function(){
    ...
    $("input").on("input", function(){  
        ...
        $('#value_din').val(value_din);//hidden value_din
        $('.value_din').text(value_din);//show value_din
        $('#pdv_din').val(pdv_din);//hidden pdv_din
        $('.pdv_din').text(value_din);//show  pdv_din
        $('#value_din_tax').val(value_din_tax);//hiddden value_din_tax
        $('.value_din_tax').text(value_din);//show value_din_tax
    }); 
